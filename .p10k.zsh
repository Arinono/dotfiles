# Generated by Powerlevel10k configuration wizard on 2021-03-18 at 23:38 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_STORYSCRIPT_ANCHOR_FOREGROUND=63

  typeset -g POWERLEVEL9K_DIR_PERSO_FOREGROUND=141
  typeset -g POWERLEVEL9K_DIR_PERSO_SHORTENED_FOREGROUND=134
  typeset -g POWERLEVEL9K_DIR_PERSO_ANCHOR_FOREGROUND=141
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%34F'   # green foreground
  ...
  # typeset -g POWERLEVEL9K_PACKAGE_CONTENT_EXPANSION='${P9K_PACKAGE_NAME//\%/%%}'
  # Custom icon.
